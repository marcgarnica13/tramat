...
- `/tramat:doctor` — environment + manifest checks (Databricks CLI/plugin/auth, tramat.yml schema, graph validation).
...
- init + canonical scaffold (`/tramat:init`), brownfield `/tramat:onboard`
